...
export class DownloadTestTool extends BaseTool {
  ...
  protected async executeImpl(
    ...
    try {
      ...
      if (downloadBandwidth === undefined) {
        throw new Error('Download bandwidth measurement failed - no results returned');
      }
      ...
      return this.createToolResult(true, downloadData, undefined, executionTime);
  ...
  private createDownloadMeasurements(options: BandwidthTestOptions): SpeedTestMeasurement[] {
